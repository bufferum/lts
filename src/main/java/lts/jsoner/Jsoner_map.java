...
public class Jsoner_map {
     ...
     * <p>Use such a record:
     * <pre>
     * {@code Iterator<Map.Entry<String, String>> iterator = Jsoner.MAP._from_json((String) json); }
    ...
    public Jsoner_map_object _set(Object key, Object value) throws Exception {
        ...
        if(key == null || value == null) {
            ...
            throw new Exception(Print.error("Key or Value equals null"));
        }
        else {
